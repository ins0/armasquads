...
-- ----------------------------
DROP TABLE IF EXISTS `api_keys_s83dks`;
CREATE TABLE `api_keys_s83dks` (
...
-- ----------------------------
DROP TABLE IF EXISTS `auth_role_roles`;
CREATE TABLE `auth_role_roles` (
...
-- ----------------------------
DROP TABLE IF EXISTS `ben_benutzer_91c48c`;
CREATE TABLE `ben_benutzer_91c48c` (
...
-- ----------------------------
DROP TABLE IF EXISTS `sqa_squad_member_4de785`;
CREATE TABLE `sqa_squad_member_4de785` (
...
-- ----------------------------
DROP TABLE IF EXISTS `sqa_squads_6d4c2s`;
CREATE TABLE `sqa_squads_6d4c2s` (
